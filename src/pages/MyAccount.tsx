...
const MyAccount = () => {
  ...
  useEffect(() => {
    ...
    const storedUser = localStorage.getItem('ecoEducatorUser') || localStorage.getItem('edoEducatorUser') || localStorage.getItem('ecoKidsUser');
  ...
  const handleLogout = async () => {
    localStorage.removeItem('ecoEducatorUser');
    toast({
      title: 'Logged out',
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      // Update Firestore if user has a uid (Firebase authenticated user)
      if (user.uid) {
      ...
      // Update localStorage
      localStorage.setItem('ecoKidsUser', JSON.stringify(updatedUser));
      setUser(updatedUser);
